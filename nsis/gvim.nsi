...
!define MULTIUSER_INSTALLMODE_UNINSTALL_REGISTRY_KEY	  "${PRODUCT_AND_VER}"
...
SectionGroup $(str_group_plugin) id_group_plugin
  Section "$(str_section_plugin_home)" id_section_pluginhome
    ...
    Call GetHomeDir
    Pop $4
    !insertmacro UAC_AsUser_ExecShell "" "$3" '/c "mkdir vimfiles \
	& cd vimfiles & mkdir ${PLUG_DIR_LIST}"' "$4" SW_HIDE
