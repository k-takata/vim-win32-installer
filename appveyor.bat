...
:: Racket
set RACKET_VER=3m_a078zk
set RACKET32_URL=https://mirror.racket-lang.org/releases/6.5/installers/racket-minimal-6.5-i386-win32.exe
set RACKET64_URL=https://mirror.racket-lang.org/releases/6.5/installers/racket-minimal-6.5-x86_64-win32.exe
