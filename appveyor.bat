...
move GvimExt\gvimext.dll   GvimExt32\gvimext.dll
...
pushd ..\nsis
"C:\Program Files (x86)\NSIS\makensis" /DVIMRT=..\runtime /DGETTEXT=c: gvim.nsi "/XOutFile ..\..\gvim_%APPVEYOR_REPO_TAG_NAME:v=%_%ARCH%.exe"
popd
