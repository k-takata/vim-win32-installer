...
:: Lua
set LUA_VER=53
set LUA32_URL=http://downloads.sourceforge.net/luabinaries/lua-5.3.4_Win32_dllw4_lib.zip
set LUA64_URL=http://downloads.sourceforge.net/luabinaries/lua-5.3.4_Win64_dllw4_lib.zip
...
:: Update PATH
path %PYTHON_DIR%;%PYTHON3_DIR%;%LUA_DIR%;%PERL_DIR%\bin;%path%;%RUBY_DIR%\bin;%RUBY_DIR%\bin\ruby_builtin_dlls;%RACKET_DIR%;%RACKET_DIR%\lib
